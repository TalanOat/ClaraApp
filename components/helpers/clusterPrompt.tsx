...
import { decryptString, loadSettingFromStorage, semanticAnalyiseEncryptedJournal, semanticAnalysis } from './reusable/journalHelper';
...
const ClusterPrompt = ({ onVisibilityChanged, data }: ClusterPromptProps) => {
    ...
    const calculateSemanticScoreForJournals = async (inputJournals: UserElement[]) => {
        ...
        for (let journal of inputJournals) {
            ...
            if (journal.body) {
                let journalSemanticScore = await semanticAnalyiseEncryptedJournal(journal.body);
                ...
                <View style={styles.contentRow}>
                    ...
                    <ScrollView style={styles.infoContainer}>
                        <View style={styles.infoRow}>
                            <Text style={styles.subHeader}>Average Overall Score</Text>
